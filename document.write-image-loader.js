var ImageLoader_0_2_x = function() {

};

ImageLoader_0_2_x.prototype.version_number = function() {
    return "0.2.0";
};

ImageLoader_0_2_x.prototype.url_to_call = function() {
...
ImageLoader_0_2_x.prototype.img_tag = function() {
	return '<img src="' + this.url_to_call() + '" width="' + this.render_width() + '" height="' + this.render_height() + '">'
};

ImageLoader_0_2_x.prototype.load_params = function(params) {
...
ImageLoader_0_2_x.prototype.render_height = function() {
	return  Math.floor(this._raw_height * this.render_width() / this._raw_width );
};

ImageLoader_0_2_x.prototype.render_width = function() {
	return Math.floor(Math.min(this._max_render_width, (this._percent_of_viewport_width * .01 * this._viewport_width)));
};

ImageLoader_0_2_x.prototype.url_request_height = function() {
  return this.render_height() * this._dpr; 
};

ImageLoader_0_2_x.prototype.url_request_width = function() {
