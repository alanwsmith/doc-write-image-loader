...
ImageLoader_0_5_x.prototype.image_string_from_params = function(params) {
    ...
    var output_string = '<img alt="' + params['alt_text'] + '" width="' + _width + '" height="' +  _height + '" src="//res.cloudinary.com/demo/image/upload/w_' + _stub_render_width + ',h_' + _stub_render_height + '/' + params['filename'] + '">';
